...
#creates a new data set with the means of all variables by activity and by subject
newdata<-group_by(testtraindata, activity, subject)
activitydf<-summarize_each(newdata, funs(mean))
